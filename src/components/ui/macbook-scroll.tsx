...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(
    scrollYProgress,
    [0, 0.2],
    [1.2, screenSize.width < 768 ? 1 : 1.5]
  );
  const scaleY = useTransform(
    scrollYProgress,
    [0, 0.2],
    [0.6, screenSize.width < 768 ? 1 : 1.5]
  );
  const translate = useTransform(
    scrollYProgress,
    [0, 1],
    [0, screenSize.width < 768 ? 600 : 1200]
  );
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className=" text-feuGold text-5xl font-black leading-tight mb-20 text-center"
      >
        {title || (
          <span>
            Looking up resources is finally easy. 
          </span>
        )}
      </motion.h2>
      {/* Lid */}
